...
class QsIO:
    ...
    def find_devices(self):
        ...
        """
        self.devs = list(usbc.find(find_all=True,
    ...
    def load_firmware(self, fileName):
        ...
        if not self.found:
            ...
            if self._write_cpu_ram(FX2RAM.FX2_RAM_RESET, b'0x01') == None:
                ...
                if not file is None:
                    ...
                    file.close()
                if self._write_cpu_ram(FX2RAM.FX2_RAM_RESET, b'0x00') == None:
    ...
    def read_eeprom(self, address, offset, length):
        ...
        if not self.found:
            ...
            command = bytearray( (0xff00 & offset) >> 8, 0xff & offset )
